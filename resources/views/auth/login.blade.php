        ...
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
            ...
            <main
                ...
                <div class="max-w-xl lg:max-w-3xl" x-data="loginForm()">
                    ...
                    <form @submit.prevent="submitForm" class="mt-8 grid grid-cols-10 gap-6">
            ...
            return {
                ...
                async submitForm() {
                    ...
                    try {
                        ...
                        localStorage.setItem('token', data.payload.accessToken.plainTextToken);
                        localStorage.setItem('user', JSON.stringify(data.payload.user));

                        // window.location.href = '/dashboard';
                        // Redirect to dashboard with token in header
                        fetch('/dashboard', {
                            method: 'GET',
                            headers: {
