...
<body class="bg-white text-zinc-900 antialiased dark:bg-zinc-900 dark:text-zinc-100 font-sans ">
    ...
    <div x-data="{
        ...
        <div class="min-h-full">
            <nav class="bg-gray-800" x-data="notificationApp">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline space-x-4">
                                    ...
                                    <a href="/"
                                        :class="{
                                            'bg-gray-900 text-white': window.location
                                                .pathname === '/',
                                            'text-gray-300 hover:bg-gray-700 hover:text-white': window
                ...
                <div class="md:hidden" id="mobile-menu" x-show="openMenu">
                    <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                        ...
                        <a href="/"
                            ...
                            class="rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Projects</a>
                        <a href="/my-assigned-tasks"
                            :class="{
                                'bg-gray-900 text-white': window.location
                                    .pathname === '/my-assigned-tasks',
